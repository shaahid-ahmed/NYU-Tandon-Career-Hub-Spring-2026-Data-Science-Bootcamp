# NYU-Tandon-Career-Hub-Spring-2026-Data-Science-Bootcamp
Welcome to the official repository for the NYU Tandon Career Hub Data Science Bootcamp (Spring 2026). Here you’ll find everything you need to follow along with the course lecture materials, homework assignments, datasets, and solutions organized week by week.
...
1. Clone the repository:  
   ```bash
   git clone https://github.com/shaahid-ahmed/NYU-Tandon-Career-Hub-Spring-2026-Data-Science-Bootcamp.git
   ```
...
📌 *This repository is intended for students enrolled in the NYU Tandon Career Hub Spring 2026 Bootcamp.*  
